...
//@ApplicationScoped
public class CustomUserTaskEventListenerConfig {
// implements UserTaskEventListenerConfig {

/*
    @Override
    public List<UserTaskEventListener> listeners() {
        return Arrays.asList(new CustomUserTaskEventListener(), new UnitOfWorkUserTaskEventListener);
    }
*/
