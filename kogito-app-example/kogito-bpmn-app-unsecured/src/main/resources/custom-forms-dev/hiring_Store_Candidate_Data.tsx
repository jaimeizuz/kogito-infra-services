    ...
    */
	...
	return (
		<div className={'pf-c-form'}>
			<FormGroup
				fieldId={'uniforms-000c-0000'}
				label={'Interface'}
				isRequired={false}>
				<TextInput
					name={'Interface'}
					id={'uniforms-000c-0000'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={Interface}
			...
			<FormGroup
				fieldId={'uniforms-000c-0001'}
				label={'Operation'}
				isRequired={false}>
				<TextInput
					name={'Operation'}
					id={'uniforms-000c-0001'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={Operation}
			...
			<Card>
				<CardBody className='pf-c-form'>
					...
					<FormGroup
						fieldId={'uniforms-000c-0004'}
						label={'Experience'}
						isRequired={false}>
						<TextInput
							name={'candidateDataRestDTO.experience'}
							id={'uniforms-000c-0004'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
					...
					<FormGroup
						fieldId={'uniforms-000c-0005'}
						label={'Full name'}
						isRequired={false}>
						<TextInput
							name={'candidateDataRestDTO.fullName'}
							id={'uniforms-000c-0005'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
			...
			<FormGroup
				fieldId={'uniforms-000c-0009'}
				label={'Implementation'}
				isRequired={false}>
				<TextInput
					name={'implementation'}
					id={'uniforms-000c-0009'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
			...
			<FormGroup
				fieldId={'uniforms-000c-000c'}
				label={'Result'}
				isRequired={false}>
				<TextInput
					name={'Result'}
					id={'uniforms-000c-000c'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={Result}
