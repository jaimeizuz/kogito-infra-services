...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "TestProcess", name = "TestProcess", hidden = false)
public class TestProcessModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<TestProcessModelOutput> {
    ...
    @Override()
    public TestProcessModelOutput toModel() {
        TestProcessModelOutput result = new TestProcessModelOutput();
        result.setId(getId());
