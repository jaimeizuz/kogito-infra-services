...
public class ProjectModel implements org.drools.modelcompiler.CanonicalKieModuleModel {
    ...
    public java.util.List<Model> getModels() {
        return java.util.Arrays.asList(new org.acme.travels.Rulesd6873a39ab144ce38651c810eeb54a7b());
    }

    public java.util.List<Model> getModelsForKieBase(String kieBaseName) {
        switch (kieBaseName) {
            case "defaultKieBase": return java.util.Arrays.asList( new org.acme.travels.Rulesd6873a39ab144ce38651c810eeb54a7b() );
        }
