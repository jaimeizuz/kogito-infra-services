...
public class DecisionCloudEventMetaFactory {
    ...
    @jakarta.enterprise.inject.Produces()
    public CloudEventMeta buildCloudEventMeta_PRODUCED_PRODUCED_DecisionResponse_New_32Hiring_32Offer() {
        return buildCloudEventMeta("DecisionResponse", "New+Hiring+Offer", org.kie.kogito.event.EventKind.PRODUCED);
    }

    @jakarta.enterprise.inject.Produces()
    public CloudEventMeta buildCloudEventMeta_PRODUCED_PRODUCED_DecisionResponseFull_New_32Hiring_32Offer() {
        return buildCloudEventMeta("DecisionResponseFull", "New+Hiring+Offer", org.kie.kogito.event.EventKind.PRODUCED);
    }

    @jakarta.enterprise.inject.Produces()
    public CloudEventMeta buildCloudEventMeta_PRODUCED_PRODUCED_DecisionResponseError_New_32Hiring_32Offer() {
        return buildCloudEventMeta("DecisionResponseError", "New+Hiring+Offer", org.kie.kogito.event.EventKind.PRODUCED);
    }
}
