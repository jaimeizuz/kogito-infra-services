    ...
    */
	...
	return (
		<div className={'pf-c-form'}>
			<FormGroup
				fieldId={'uniforms-000y-0000'}
				label={'Variable 1'}
				isRequired={false}>
				<TextInput
					name={'variable1'}
					id={'uniforms-000y-0000'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable1}
			...
			<FormGroup
				fieldId={'uniforms-000y-0001'}
				label={'Variable 2'}
				isRequired={false}>
				<TextInput
					name={'variable2'}
					id={'uniforms-000y-0001'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable2}
			...
			<FormGroup
				fieldId={'uniforms-000y-0002'}
				label={'Variable 3'}
				isRequired={false}>
				<TextInput
					name={'variable3'}
					id={'uniforms-000y-0002'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable3}
			...
			<FormGroup
				fieldId={'uniforms-000y-0003'}
				label={'Variable 4'}
				isRequired={false}>
				<TextInput
					name={'variable4'}
					id={'uniforms-000y-0003'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable4}
