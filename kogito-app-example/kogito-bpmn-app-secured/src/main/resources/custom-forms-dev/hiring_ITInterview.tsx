		...
		<div className={'pf-c-form'}>
			<Card>
				<CardBody className='pf-c-form'>
					...
					<FormGroup
						fieldId={'uniforms-000s-0002'}
						label={'Email'}
						isRequired={false}>
						<TextInput
							name={'candidate.email'}
							id={'uniforms-000s-0002'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
					...
					<FormGroup
						fieldId={'uniforms-000s-0005'}
						label={'Last name'}
						isRequired={false}>
						<TextInput
							name={'candidate.lastName'}
							id={'uniforms-000s-0005'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
					...
					<FormGroup
						fieldId={'uniforms-000s-0006'}
						label={'Name'}
						isRequired={false}>
						<TextInput
							name={'candidate.name'}
							id={'uniforms-000s-0006'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
							...
							{candidate__skills?.map((_, itemIndex) => (
								<div
									...
									<div style={{ width: '100%', marginRight: '10px' }}>
										<FormGroup
											fieldId={'uniforms-000s-0009'}
											label={''}
											isRequired={false}>
											<TextInput
												name={`candidate__skills.${itemIndex}`}
												id={'uniforms-000s-0009'}
												isDisabled={true}
												placeholder={''}
												type={'text'}
			...
			<Card>
				<CardBody className='pf-c-form'>
					...
					<FormGroup
						fieldId={'uniforms-000s-000c'}
						label={'Category'}
						isRequired={false}>
						<TextInput
							name={'offer.category'}
							id={'uniforms-000s-000c'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
			...
			<FormGroup fieldId='uniforms-000s-000g'>
				<Checkbox
					isChecked={approve}
					isDisabled={false}
					id={'uniforms-000s-000g'}
					name={'approve'}
					label={'Approve'}
