    ...
    */
	...
	return (
		<div className={'pf-c-form'}>
			<FormGroup
				fieldId={'uniforms-0010-0000'}
				label={'Variable 1'}
				isRequired={false}>
				<TextInput
					name={'variable1'}
					id={'uniforms-0010-0000'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={variable1}
			...
			<FormGroup
				fieldId={'uniforms-0010-0001'}
				label={'Variable 2'}
				isRequired={false}>
				<TextInput
					name={'variable2'}
					id={'uniforms-0010-0001'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={variable2}
			...
			<FormGroup
				fieldId={'uniforms-0010-0002'}
				label={'Variable 3'}
				isRequired={false}>
				<TextInput
					name={'variable3'}
					id={'uniforms-0010-0002'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={variable3}
			...
			<FormGroup
				fieldId={'uniforms-0010-0003'}
				label={'Variable 4'}
				isRequired={false}>
				<TextInput
					name={'variable4'}
					id={'uniforms-0010-0003'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={variable4}
			...
			<FormGroup fieldId='uniforms-0010-0005'>
				<Checkbox
					isChecked={repeatTask}
					isDisabled={false}
					id={'uniforms-0010-0005'}
					name={'repeatTask'}
					label={'Repeat task'}
