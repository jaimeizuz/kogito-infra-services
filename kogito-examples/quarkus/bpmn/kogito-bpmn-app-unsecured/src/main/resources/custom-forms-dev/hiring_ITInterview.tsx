		...
		<div className={'pf-c-form'}>
			<Card>
				<CardBody className='pf-c-form'>
					...
					<FormGroup
						fieldId={'uniforms-0008-0002'}
						label={'Email'}
						isRequired={false}>
						<TextInput
							name={'candidate.email'}
							id={'uniforms-0008-0002'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
			...
			<Card>
				<CardBody className='pf-c-form'>
					...
					<FormGroup
						fieldId={'uniforms-0008-000c'}
						label={'Category'}
						isRequired={false}>
						<TextInput
							name={'offer.category'}
							id={'uniforms-0008-000c'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
			...
			<FormGroup fieldId='uniforms-0008-000g'>
				<Checkbox
					isChecked={approve}
					isDisabled={false}
					id={'uniforms-0008-000g'}
					name={'approve'}
					label={'Approve'}
