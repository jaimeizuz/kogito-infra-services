...
const Form__TestProcess: React.FC<any> = (props: any) => {
	...
	const getFormData = useCallback(() => {
		const formData: any = {};
		formData.variable1 = variable1;
		formData.variable2 = variable2;
		formData.variable3 = variable3;
		formData.variable4 = variable4;
		return formData;
    ...
    */
	...
	return (
		<div className={'pf-c-form'}>
			<FormGroup
				fieldId={'uniforms-000e-0000'}
				label={'Variable 1'}
				isRequired={false}>
				<TextInput
					name={'variable1'}
					id={'uniforms-000e-0000'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable1}
			...
			<FormGroup
				fieldId={'uniforms-000e-0001'}
				label={'Variable 2'}
				isRequired={false}>
				<TextInput
					name={'variable2'}
					id={'uniforms-000e-0001'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable2}
			...
			<FormGroup
				fieldId={'uniforms-000e-0002'}
				label={'Variable 3'}
				isRequired={false}>
				<TextInput
					name={'variable3'}
					id={'uniforms-000e-0002'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable3}
			...
			<FormGroup
				fieldId={'uniforms-000e-0003'}
				label={'Variable 4'}
				isRequired={false}>
				<TextInput
					name={'variable4'}
					id={'uniforms-000e-0003'}
					isDisabled={false}
					placeholder={''}
					type={'text'}
					value={variable4}
...
export default Form__TestProcess;
